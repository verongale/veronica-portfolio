...
export default function Footer() {
  return (
    <footer className="border-t border-white/5 pt-12 pb-24 mt-24 space-y-8">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div className="space-y-2">
          <h2 className="text-3xl font-extrabold tracking-tight text-brand-text font-sans">Let's build something together.</h2>
          <p className="text-sm text-brand-muted max-w-md leading-relaxed font-sans">
            I am currently looking for remote roles and B2B contracting opportunities across Europe.
          </p>
        </div>
        <a 
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-start md:items-center pt-8 border-t border-white/5 gap-4 text-xs text-brand-muted/70">
        ...
        <div className="flex space-x-6 font-medium text-brand-text font-sans">
          <a href="https://github.com/verongale/" target="_blank" rel="noopener noreferrer" className="hover:text-brand-cyan transition-colors">GitHub</a>
